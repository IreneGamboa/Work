...
public class AjustePropina extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater.inflate(R.layout.ajuste_propina, container,
				false);
		...
		elv.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				builder.setView(inflater.inflate(R.layout.dialog_tip, null))
						.setTitle(R.string.ajusteP)
								...
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
										...
										Intent voucher = new Intent(
												AjustePropina.this.getActivity(),
												Voucher.class);
	...
	public class SavedTabsListAdapter extends BaseExpandableListAdapter {
		...
		private String[] groups = { "Venta Colones", "Venta Dolares",
				"Venta MiniCuotas" };
